...
public class EmpleadoImpl extends Conexion implements EmpleadoI {
    ...
    public void agregarEmpleado(EmpleadoM empleado) throws Exception {
        ...
        try {
            ...
            ps.setString(9, empleado.getFECEMP());
            ...
            ps.setString(16, empleado.getFEIEMP());
            ps.setString(17, empleado.getFENEMP());
            ...
            ps.setString(23, empleado.getFEAEMP());
    ...
    public List<EmpleadoM> listarEmpleado() throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                empleado.setFECEMP(rs.getString("FECEMP"));
                ...
                empleado.setFEIEMP(rs.getString("FEIEMP"));
                empleado.setFENEMP(rs.getString("FENEMP"));
                ...
                empleado.setFEAEMP(rs.getString("FEAEMP"));
